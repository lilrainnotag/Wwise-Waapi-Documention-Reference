...
▎ **命名空间**: `ak.soundengine`
▎ **对应C++ API**: `AK::SoundEngine::LoadBank`
...
```json
{
  "method": "ak.soundengine.loadBank",
  "params": {
...
- 加载 SoundBank 后，其中的 Event、Sound 等资源才可使用

## 相关函数

- [ak.soundengine.unloadBank](ak.soundengine.unloadBank.md)

## 官方文档链接

https://www.audiokinetic.com/library/2024.1.14_9084/?source=SDK&id=ak_soundengine_loadBank.html
